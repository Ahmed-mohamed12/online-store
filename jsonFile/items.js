...
//   const projectsArray = [
//     // ... (قائمة المنتجات كما هي)
// ];

const panner = document.getElementById("panner");
const other_products = document.getElementById("other-products");
const third_products = document.getElementById("third-products");
...
// عرض المنتجات في panner
projectsArray.forEach((pro) => {
    if (pro.old_price) {
        const discount = Math.floor(((pro.old_price - pro.price) / pro.old_price) * 100);
        panner.innerHTML += `
            <div class="product item" key="${pro.id}">
                ...
                <div class="price">
                    ...
                    <p class="old-price">${pro.old_price}</p>
                </div>
            </div>
        `;
    }
...
// عرض المنتجات في other_products
projectsArray.forEach((pro) => {
...
// عرض المنتجات في third_products
projectsArray.forEach((pro) => {
    third_products.innerHTML += `
        <div class="product item" key="${pro.id}">
            <div class="icons">
                <i class="fa-solid fa-cart-plus" data-id="${pro.id}" onclick="addToCart(${pro.id}, this)"></i>
                <i class="fa-solid fa-heart"></i>
